<cfcomponent name="LightBaseBeanConfig" extends="lightwire.BaseConfigObject" hint="A LightWire configuration bean.">
<!--- 
...
<cffunction name="init" output="false" returntype="any" hint="I initialize the config bean.">
    ...
    addSingleton( "logging.LoggerFactory" );
    
    //addSingleton( "logging.appenders.FileAppender", "BasicAppender" );
    //addConstructorProperty( "BasicAppender", "name", "basic" );
    //addConstructorProperty( "BasicAppender", "file",  dir & "base.log" );
    
    addSingletonFromFactory( "LoggerFactory", "getLogger", "Logger" );
    addConstructorProperty( "Logger", "name", "base" );
    //addMixinDependency( "Logger", "addAppender", "BasicAppender" );
    /*
    addSingleton( "logging.layout.ExceptionLayout" );
    addSingleton( "logging.appenders.FileAppender", "ExceptionAppender" );
    addConstructorProperty( "ExceptionAppender", "name", "basic" );
    addConstructorProperty( "ExceptionAppender", "file",  dir & "test.log" );
    addConstructorDependency( "ExceptionAppender", "layout", "ExceptionLayout" );
    */
